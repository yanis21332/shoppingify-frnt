...
const AuthPage = ({ connexionType }) => {
    ...
    const onLogin = (e) => {
        ...
        axios.post("https://back-shoppingify-younow.herokuapp.com/auth/login",data).then(res=>{
            if(!res.data.error){
    ...
    const onSignup = (e) => {
        ...
        axios.post("https://back-shoppingify-younow.herokuapp.com/auth/createuser",data).then(res=>{
            if(!res.data.error){
                setError(null)
